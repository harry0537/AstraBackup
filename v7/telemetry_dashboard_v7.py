#!/usr/bin/env python3
"""
Project Astra NZ - Web Telemetry Dashboard V7
Real-time monitoring interface for proximity sensors and system status - Clean Version
"""
...
<html>
<head>
    <title>Project Astra NZ - Telemetry Dashboard V7</title>
    <meta charset="utf-8">
...
<body>
    <div class="header">
        <h1>PROJECT ASTRA NZ - TELEMETRY DASHBOARD V7</h1>
        <p id="timestamp">--:--:--</p>
    </div>
...
if __name__ == '__main__':
    ...
    if '--simulate' in sys.argv:
        ...
        print("Reading telemetry from /tmp/proximity_v7.json")
    ...
    # Start Flask server
    print("\n" + "="*50)
    print("PROJECT ASTRA NZ - TELEMETRY DASHBOARD V7")
    print("="*50)
