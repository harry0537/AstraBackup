...
class ComboProximityBridge:
    ...
    def connect_lidar(self):
        """Connect to RPLidar S3 using aggressive buffer management (mirror working script)."""
        try:
            ...
            for port in candidate_ports:
                try:
                    ...
                    # Match working script: shorter timeout
    ...
    def connect_pixhawk(self):
        """Connect to Pixhawk via MAVLink (mirror working script heartbeat and IDs)."""
        try:
