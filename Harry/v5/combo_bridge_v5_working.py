#!/usr/bin/env python3
"""
Project Astra NZ - Combo Proximity Bridge v5 Working
Copied exact LiDAR and RealSense methods from working_combo_proximity.py
"""
...
class ComboProximityBridge:
    def __init__(self):
        # EXACT HARDWARE CONFIG FROM WORKING VERSION
        ...
        print("Project Astra NZ - Combo Proximity Bridge v5 Working")
        print("Using exact working LiDAR and RealSense methods")
        print("=" * 60)
    
    def aggressive_buffer_clear(self):
        """EXACT COPY: Aggressively clear RPLidar buffers"""
        try:
    ...
    def connect_rplidar(self):
        """EXACT COPY: Working RPLidar connection method"""
        try:
    ...
    def connect_realsense(self):
        """EXACT COPY: Working RealSense connection method"""
        ...
        try:
            ...
            # EXACT CONFIG FROM WORKING VERSION: Lower resolution for better performance
    ...
    def lidar_continuous_thread(self):
        """EXACT COPY: Continuous RPLidar processing in background thread"""
    ...
    def get_realsense_data(self):
        """EXACT COPY: Get RealSense sector data"""
    ...
    def fuse_sensor_data(self):
        """EXACT COPY: Combine RPLidar and RealSense data intelligently"""
    ...
    def send_proximity_data(self, sector_distances):
        """EXACT COPY: Send DISTANCE_SENSOR messages to Pixhawk"""
        try:
    ...
    def run(self):
        """EXACT COPY: Main processing loop"""
        if not self.connect_devices():
            return False
        
        print("\nCombo Proximity Bridge v5 Working...")
        print("Exact methods from working_combo_proximity.py")
