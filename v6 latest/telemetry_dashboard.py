#!/usr/bin/env python3
"""
Project Astra NZ - Web Telemetry Dashboard
Real-time monitoring interface for proximity sensors and system status
"""
...
<html>
<head>
    <title>Project Astra NZ - Telemetry Dashboard</title>
    <meta charset="utf-8">
...
<body>
    <div class="header">
        <h1>PROJECT ASTRA NZ - TELEMETRY DASHBOARD</h1>
        <p id="timestamp">--:--:--</p>
    </div>
...
def read_telemetry_file():
    ...
    while True:
        try:
            with open('/tmp/astra_telemetry.json', 'r') as f:
                data = json.load(f)
...
if __name__ == '__main__':
    ...
    if '--simulate' in sys.argv:
        ...
        print("Reading telemetry from /tmp/astra_telemetry.json")
    ...
    # Start Flask server
    print("\n" + "="*50)
    print("PROJECT ASTRA NZ - TELEMETRY DASHBOARD")
    print("="*50)
