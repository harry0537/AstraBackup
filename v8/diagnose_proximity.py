#!/usr/bin/env python3
"""
Proximity Bridge Diagnostic Tool
...
def check_config_file():
    ...
    if os.path.exists(config_file):
        ...
        try:
            ...
            print(f"  JSON valid: ✗ Invalid JSON: {e}")
        except Exception as e:
...
def main():
    print("PROXIMITY BRIDGE DIAGNOSTIC TOOL")
    print("=" * 50)
    ...
    print("\nIf you see any ✗ marks above, those are likely causes")
