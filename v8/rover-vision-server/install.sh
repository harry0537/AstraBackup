...
MANAGER="$INSTALL_DIR/scripts/rover_manager.py"
CONFIG="$INSTALL_DIR/config/rover_config.json"
SERVICE_NAME="rover-vision"
...
ExecStart=$VENV_DIR/bin/python3 $INSTALL_DIR/scripts/rover_manager.py
Restart=always
RestartSec=10
