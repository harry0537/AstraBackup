#!/usr/bin/env python3
"""
Project Astra NZ - Data Relay V6 (Component 197)
Relays telemetry and images to AWS dashboard every minute
"""
...
class DataRelay:
    ...
    def send_image(self):
        ...
        try:
            ...
            if file_age > 90:  # Don't send if older than 90 seconds
                return False
    ...
    def run(self):
        """Main execution"""
        print("=" * 60)
        print("Data Relay V6 - Component 197")
